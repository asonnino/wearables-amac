...
define("COOKIE_SECRET_KEY", "1gp@TMPS{+$74sspMJFe-82s");
...
define("EMAIL_SMTP_HOST", "ssl://smtp.gmail.com");
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "alfcorp.info@gmail.com");
define("EMAIL_SMTP_PASSWORD", "AlfMailInfo14");
define("EMAIL_SMTP_PORT", 465);
define("EMAIL_SMTP_ENCRYPTION", "ssl");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://alfcorp.no-ip.info/php-login-advanced-master/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "no-reply@example.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "ALF Corp.");
define("EMAIL_PASSWORDRESET_SUBJECT", "ALF Corp. - Password reset");
 ...
 */
define("EMAIL_VERIFICATION_URL", "http://alfcorp.no-ip.info/php-login-advanced-master/register.php");
define("EMAIL_VERIFICATION_FROM", "no-reply@example.com");
define("EMAIL_VERIFICATION_FROM_NAME", "ALF Corp.");
define("EMAIL_VERIFICATION_SUBJECT", "ALF Corp. - Account activation");
