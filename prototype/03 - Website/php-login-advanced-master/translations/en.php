...
define("MESSAGE_CAPTCHA_WRONG", "Wrong captcha, try again.");
...
define("MESSAGE_EMAIL_INVALID", "Malformed email address.");
...
define("MESSAGE_LOGIN_FAILED", "Wrong username or password.");
define("MESSAGE_OLD_PASSWORD_WRONG", "Your OLD password was wrong.");
define("MESSAGE_PASSWORD_BAD_CONFIRM", "The password and the confirmation are not the same.");
...
define("WORDING_REQUEST_PASSWORD_RESET", "Enter your username below and follow the instruction sent by email:");
